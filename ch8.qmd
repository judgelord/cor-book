...
The first Trump administration sought to limit congressional oversight, in the first few months of taking office suggesting that agencies should only respond to requests that come from a committee, subcommittee, or chairman authorized to conduct oversight [@OfficeofLegalCounsel2017]. However, a follow-up memo two years later clarified that "[d]epartments and agencies ... may appropriately give due weight and sympathetic consideration to requests for information from individual members of Congress not delegated such authority"  [@OfficeofLegalCounsel2019].
...
## Inequality in Policy Work


Like other forms of interbranch representation, policy work is highly unequal, though slightly less unequal than constituency service on behalf of individuals, businesses, nonprofits, or local governments. Inequality in interbranch policy work mirrors 2024 levels of income inequality in Mexico (.43) and the United States (.42) for the House and the Senate, respectively. @fig-percent-5 shows many of the offices that provided the most constituency service also did the most policy work, including Senator Grassley and Representatives Pallone and Rahall. 
Other top offices for interbranch policy work were not leading providers of constituency service, including Senators Harkin and Hatch (though Harkin was near the top for work on behalf of nonprofits and local governments). 
...
Variation in policy work is mainly driven by capacity, especially experience and institutional positions.
Supporting theories that view interbranch relations as coalitional networks rather than principals and agents focusing on control and oversight, policy work tends to be with agencies that are perceived as ideologically aligned. 
Doing more with aligned agencies is the only strategic choice that matters. 
...
Most forms of capacity matter with large effects explaining a large share of overall inequality.	
...
@fig-effect-staff shows that staff allocation has a substantively large relationship with the volume of policy work but does not explain a large share of the inequality. 
