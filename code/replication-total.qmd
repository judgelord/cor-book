...
# same party 
load(here::here("data", "same_party_crosswalk.rda"))

### 
# TRANSFORMATIONS WITH MEMBERS 
...
d <- d |> 
  mutate(
    oversight_agencies = oversight |> str_replace_all(";","|"),
...
- Figures: `figs/negbin-m-total-House-[1:4].png`

```{r}
#| label: "negbin-m-total-House"
#| fig-cap: "figs/negbin-m-total-House-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
m_total_cross_House <-fenegbin (perYear ~ 
                    ...
                    majority + presidents_party | Year_x_Agency,
                    cluster = "Legislator", 
           data = dcounts_tenure |> filter(chamber=="House"))
...
# Model 2
m_total_dnd_House <-fenegbin (perYear ~ 
                       chair + ranking_minority + prestige + 
                    first + second + third + fourth + fifth + sixth + 
                    majority + presidents_party | Year_x_Agency + Legislator_x_Agency, 
                    cluster = "Legislator",
...
if(testing){modelsummary::modelsummary(m_total_dnd_House)}

coefplot(m_total_dnd_House, horiz = T) 
...
m_total_2nd_House <-fenegbin (perYear ~ 
                    ...
                    majority + presidents_party | Year_x_Agency + Legislator_x_Agency, 
                    cluster = "Legislator", 
           data = dcounts_tenure |> filter(survive == 1)  |> filter(chamber=="House"))

if(testing){modelsummary::modelsummary(m_total_2nd_House)}
coefplot(m_total_2nd_House, horiz = T) 


# 4
m_logtotal_dnd_House <-fenegbin (log(perYear + 1) ~ 
                          chair + ranking_minority + prestige + 
                    first + second + third + fourth + fifth + sixth + 
                    majority + presidents_party | Year_x_Agency + Legislator_x_Agency, 
                    cluster = "Legislator", 
...
if(testing){modelsummary::modelsummary(m_logtotal_dnd_House)}

coefplot(m_logtotal_dnd_House, horiz = T) 
...
- Figures: `figs/negbin-m-total-Senate-[1:4].png`

```{r}
#| label: "negbin-m-total-Senate"
#| fig-cap: "figs/negbin-m-total-Senate-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
# Model 1 
# cross-sectional 
m_total_cross_Senate <-fenegbin (perYear ~ 
                         chair + ranking_minority + prestige + 
                    first + second + third + fourth + fifth + sixth  + 
                    majority + presidents_party | Year_x_Agency,
                    cluster = "Legislator", 
           data = dcounts_tenure |> filter(chamber=="Senate"))
...
# Model 2
m_total_dnd_Senate <-fenegbin (perYear ~ 
                       chair + ranking_minority + prestige + 
                    first + second + third + fourth + fifth + sixth + 
                    majority + presidents_party | Year_x_Agency + Legislator_x_Agency, 
                    cluster = "Legislator",
...
if(testing){modelsummary::modelsummary(m_total_dnd_Senate)}

coefplot(m_total_dnd_Senate, horiz = T) 
...
m_total_2nd_Senate <-fenegbin (perYear ~ 
                    ...
                    majority + presidents_party | Year_x_Agency + Legislator_x_Agency, 
                    cluster = "Legislator", 
           data = dcounts_tenure |> filter(survive == 1)  |> filter(chamber=="Senate"))

if(testing){modelsummary::modelsummary(m_total_2nd_Senate)}
coefplot(m_total_2nd_Senate, horiz = T) 


# 4
m_logtotal_dnd_Senate <-fenegbin (log(perYear + 1) ~ 
                          chair + ranking_minority + prestige + 
                    first + second + third + fourth + fifth + sixth + 
                    majority + presidents_party | Year_x_Agency + Legislator_x_Agency, 
                    cluster = "Legislator", 
...
if(testing){modelsummary::modelsummary(m_logtotal_dnd_Senate)}

coefplot(m_logtotal_dnd_Senate, horiz = T) 
...
avg_effect_House <- m_total_cross_House |> # m_total_dnd_House |>
  avg_comparisons(
    variables = c("chair")) 

avg_effect_Senate <- m_total_cross_Senate |> # m_total_dnd_Senate |>
  avg_comparisons(
    variables = c("chair")) 
